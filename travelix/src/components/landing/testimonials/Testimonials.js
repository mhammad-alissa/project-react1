				...
				<div className="col">
					...
					<div className="test_slider_container">
						<div className="owl-carousel owl-theme test_slider">
                            ...
                            <TestimonialsItem image_src={"personsImages/person1.jpg"} />
                            <TestimonialsItem image_src={"personsImages/person2.jpg"} />
                            <TestimonialsItem image_src={"personsImages/person3.jpg"} />
                            <TestimonialsItem image_src={"personsImages/person4.jpg"} />
