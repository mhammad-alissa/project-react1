  ...
  render() {
    return (
                        ...
                        <div className="row">
                            <div className="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                                <div className="logo_container">
                                    <div className="logo"><Link to="/Home"><img src="images/logo.png" alt=""/>travelix</Link></div>
                                </div>
                                <div className="main_nav_container ml-auto">
                                    <ul className="main_nav_list">
                                        <li className="main_nav_item"><Link to="/" onClick={(e)=>this.locationHandler(e)}>Home</Link></li>
                                        <li className="main_nav_item"><Link to="/about us">about us</Link></li>
                                        ...
                                        <li className="main_nav_item"><Link to="/login" onClick={(e)=>this.locationHandler(e)}>Login</Link></li>
                                ...
                                <div className="content_search ml-lg-0 ml-auto">
                                    ...
                                    width="17px" height="17px" viewBox="0 0 512 512" enableBackground="new 0 0 512 512" xmlSpace="preserve">
                                        <g>
                                            <g>
                                                <g>
		...
		<div className="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<div className="logo menu_logo"><a href="#"><img src="images/logo.png" alt="logo" /></a></div>
			<ul>
